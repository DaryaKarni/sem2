...
class Image(QWidget):
    def __init__(self):
        ...
        #self.label = QLabel()
        #self.label.setContentsMargins(200, 0, 200, 0)
        ...
        #self.button.clicked.connect(ShowImage)
        self.setGeometry(200,100,1000,500)
        self.setWindowTitle("PyQT show image")
        self.show()


        #input.editingFinished.connect(Image.OpenImage())
    ...
    """def OpenImage(self):
        self.pixmap = QPixmap(input.displayText())
        self.pixmap.scaled(600,600)
        self.picture.setPixmap(self.pixmap)
